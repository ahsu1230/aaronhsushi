export default function InspirationBuyFish(props) {
  return (
    <div className="inspiration-buy-fish">
      ...
      <p>
        For high-quality fresh fish, I recommend going to the selected stores
        below. For generic Japanese cooking and sushi equipment, they should be
        available at any local Japanese store near you!
      </p>
      <div className="cards">
        <Card
      ...
      <div>
        ...
        <p>
          While raw fish from Whole Foods & Costco can be used for sushi, they
          are certainly a bit riskier. The linked sources above are more
          guaranteed to provide sushi-grade fish as they take much better care
          of their fresh seafood. For best results at places like Costco, Whole
          Foods, H-mart, etc. I highly recommend only getting fish from places
          with high seafood traffic. Fish is less likely to be sitting around
        ...
        <p>
          ...
          distribution companies in New York to sell their premium fish to
          non-Asian restaurants. All it really means is very, very (think A++
          grade) fresh fish, but there is currently no metric in the U.S to
          measure this.
          <br />
          <br />
          So how can I tell fish is sushi-grade? There are a few tips you can
          use to tell if fish is safe to be consumed raw. Generally, you want
          fish fillets to not have any trace of blood on them and not be exposed
          to air for too long. When you smell fish, there should be no "fishy"
          smell - it should smell like the ocean! And when you touch a fish
          fillet (if you're allowed to), the meat should be firm and not grainy.
        </p>
        <p>
