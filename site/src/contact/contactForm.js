...
function FormSelectType(props) {
    ...
    return (
        <section>
            ...
            <form>
                <div>
                    <input type="radio" name="party_selection" value="party_2" onChange={onSelectType}/>
                    <label for="party_2">Omakase Tasting (up to 2)</label>
                </div>
                <div>
                    <input type="radio" name="party_selection" value="party_4" onChange={onSelectType}/>
...
function FormInformation(props) {
    ...
    const onChangeNum = (fieldName, num) => onChange(fieldName, parseInt(num, 10) || 0);
